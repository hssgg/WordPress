<?php
//{"lang":"en","auth_pass":"526e03aa6a6a00e4423feefdab484d4a","error_reporting":"1"}
$version = 1.6;
$charset = 'UTF-8';
$quota_mb = 0;
...
function dir_list_form() {
    ...
    if ($opdir = @opendir(fs_encode($fm_current_dir))) {
        ...
        if($entry_count){
            ...
            $tt = ($tf - $ti);
            $out .= "
                <tr><td bgcolor=\"#DDDDDD\" colspan=50><b>".et('RenderTime')."<label onclick=\"config_form()\">".":</label>".substr($tt,0,strrpos($tt,".")+5)." ".et('Seconds')."</td></tr>";
            $out .= "
            <script language=\"Javascript\" type=\"text/javascript\">
            <!--
                update_sel_status();
...
function about_form(){
    ...
    <iframe id=\"aboutIframe\" name=\"aboutIframe\" src=\"http://".$version."\" scrolling=\"yes\" frameborder=\"0\"></iframe>
    </body>\n</html>";
}
// +--------------------------------------------------
